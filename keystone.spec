...
Source0  : http://tarballs.openstack.org/keystone/keystone-13.0.0.tar.gz
Source1  : keystone.tmpfiles
Source99 : http://tarballs.openstack.org/keystone/keystone-13.0.0.tar.gz.asc
...
export LANG=C
export SOURCE_DATE_EPOCH=1532376350
