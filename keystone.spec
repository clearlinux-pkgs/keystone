...
Version  : 8.1.0
Release  : 80
URL      : http://tarballs.openstack.org/keystone/keystone-8.1.0.tar.gz
Source0  : http://tarballs.openstack.org/keystone/keystone-8.1.0.tar.gz
